...
public class DBConfig {
    public static final String adminPanelInfoSheet = "1ggrj5icBrdrHhto4CeJCWFz931TOWjYBQW034_S4lCE";//"1irsJGItfs5yU5iyPxmxJ8VpQg-V7DzML3nGE2OnyaUs"; //
    ...
    public static final String templatesListRange = "GroupTemplateLink!A2:"+ templatesEdge + templatesCount;
    ...
    public static final int scheduleRowNumber = 22;
    public static final char dayScheduleEdge = 'W';
    public static final String scheduleTableRange = "РОЗКЛАД!A5:" + dayScheduleEdge + scheduleRowNumber;
